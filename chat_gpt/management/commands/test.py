...
def generate_text():
    """{{"worker":  Кирилл Куликов, "metrix": [{{"metrix_id": 0, "score": 2, "text": "Сотрудник выполнил лишь 26% от
поставленных задач. Выполнял задачи долго."}}, {{"metrix_id": 1, "score": 5, "text": " Сотрудник организовывает
    ...
    data = [
        {
            ...
            "metrix": [
                {"metrix_id": 0, "score": 3, "text": "Сотрудник был мотивирован, но не всегда выполнял задачи "
                                                     "корректно из-за плохой коммуникации."},
                {"metrix_id": 1, "score": 2, "text": "Сотрудник не предлагал ничего нового, а просто плыл по "
                                                     "течению."},
            ]
        },
        {
            ...
            "metrix": [
                {"metrix_id": 0, "score": 2, "text": "Сотрудник выполнил лишь 26% от поставленных задач. Выполнял "
                                                     "задачи долго."},
                {"metrix_id": 1, "score": 5, "text": "Cотрудник организовывает мероприятие 'пятница настольных игр'. "
...
{{"metrix": ["id": Айди метрики, "name": Название метрики]}}

Массив метрик в формате json: {{"author": Имя автора, который оставляет отзыв, "metriks": [{{"metrix_id": id 
